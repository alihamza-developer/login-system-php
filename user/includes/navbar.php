    ...
    <div class="menu">
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="setting" class="dropdown-item"><?= svg_icon("user-cog") ?> <span class="text">Profile setting</span></a>
                <?php if (IS_ADMIN) { ?>
                    <a href="<?= _DIR_ ?>admin/dashboard" class="dropdown-item"><?= svg_icon("external-link-alt") ?> <span class="text">Admin panel</span></a>
                <?php } ?>
                <a href="logout" class="dropdown-item is-danger"><?= svg_icon("sign-out-alt") ?> <span class="text">Logout</span></a>
            </div>
        </div>
    </div>
</nav>